 ...
 * @property {NodeJS.WriteStream | "buffer"} [stdout] (optional) Where to redirect the stdout or "buffer" to return it as a string. Default: process.stdout
 * @property {NodeJS.WriteStream | "buffer"} [stderr] (optional) Where to redirect the stderr or "buffer" to return it as a string. Default: process.stderr
 */
...
function npmCommand(command, npmArgs, options) {
    ...
    const spawnOptions = {
        stdio: [
            ...
            options.stdout === 'buffer' ? 'pipe' : options.stdout || process.stdout,
            options.stderr === 'buffer' ? 'pipe' : options.stderr || process.stderr,
        ],
